          ...
          <AnimatePresence>
            {notifOpen && (
              <motion.div
                ...
                className="absolute right-0 top-full mt-2 w-80 glass-panel shadow-2xl overflow-hidden"
              >
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.slice(0, 8).map(n => (
                      ...
                      >
                        ...
                        {!n.read && (
                          <div className="w-1.5 h-1.5 bg-accent rounded-full flex-shrink-0 mt-1" />
                        )}
                      </div>
                    ))
                  )}
